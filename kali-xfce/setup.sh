...
sudo apt update
sudo apt install tilix python-pip python3-nautilus nautilus neofetch htop fonts-noto-color-emoji rofi ranger remmina golang-go kali-grant-root kali-root-login -y
